                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-row">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input disabled type="text" class="form-control form-control-sm" id="validationTooltip01" placeholder="First name" title="<?= $userdetails['sinta_id']; ?>"  value="<?= $userdetails['sinta_id']; ?>" required>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input disabled type="text" class="form-control form-control-sm" id="validationTooltip02" placeholder="Last name" title="<?= $userdetails['name']; ?>" value="<?= $userdetails['name']; ?>" required>
                                                    <div class="valid-tooltip">
                                                        <?= $userdetails['name']; ?>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input disabled type="text" class="form-control form-control-sm" id="validationTooltip02" placeholder="Last name" title="<?= $userdetails['google_id']; ?>" value="<?= $userdetails['google_id']; ?>" required>
                                                    <div class="valid-tooltip">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input disabled type="text" class="form-control form-control-sm" id="validationTooltip02" placeholder="Last name" tile="<?= $userdetails['afiliasi']['name']; ?>" value="<?= $userdetails['afiliasi']['name']; ?>" required>
                                                    <div class="valid-tooltip">
