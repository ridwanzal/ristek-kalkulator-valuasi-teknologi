            ...
            <div class="card text-center">
                ...
                <form>
                    <div class="form-group row">                        
                        <label for="target" class="col-sm-6 col-form-label text-right">Target Produksi &nbsp;<span class="badge badge-pill  badge-warning">2.1</span> &nbsp;<a href="#" class="badge badge-info">Info</a></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">                        
                        <label for="marketshare_persen" class="col-sm-6 col-form-label text-right">Proyeksi Market Share di Tahun Pertama (Prosentase) &nbsp;<span class="badge badge-pill  badge-warning">2.2</span> &nbsp;<a href="#" class="badge badge-info">Info</a></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">                        
                        <label for="qty_tahun1" class="col-sm-6 col-form-label text-right">Jumlah Produk di Tahun Pertama &nbsp;<span class="badge badge-pill  badge-warning">2.3</span> &nbsp;<a href="#" class="badge badge-info">Info</a></label>
                    ...
                    <div class="form-group row">                        
                        <label for="marketshare_tahun2" class="col-sm-6 col-form-label text-right">Proyeksi Market Share mulai Tahun Ke -2 (Prosentase) &nbsp;<span class="badge badge-pill  badge-warning">2.4</span> &nbsp;<a href="#" class="badge badge-info">Info</a></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">                        
                        <label for="harga_tahun1" class="col-sm-6 col-form-label text-right">Harga Jual Produk (Tahun Pertama) &nbsp;<span class="badge badge-pill  badge-warning">2.5</span> &nbsp;<a href="#" class="badge badge-info">Info</a></label>
                        <div class="col-md-6 text-left">
                    ...
                    <div class="form-group row">                        
                        <label for="harga_tahun2" class="col-sm-6 col-form-label text-right">Harga Jual Produk mulai Tahun ke - 2 (Prosentase) &nbsp;<span class="badge badge-pill  badge-warning">2.6</span> &nbsp;<a href="#" class="badge badge-info">Info</a></label>
                        <div class="col-sm-6">
