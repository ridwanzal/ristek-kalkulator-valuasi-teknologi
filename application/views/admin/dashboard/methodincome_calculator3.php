        ...
        <div class="col-md-12 center">
            <div class="card text-center">
                ...
                <!-- <form method="POST" name="frmhalaman3" id="frmhalaman3" action="<?=base_url() ?>manage/add/incomebased_output"> -->                    
                    ...
                    <div class="form-group row">                        
                        <label for="biaya_depresiasi" class="col-sm-6 col-form-label text-right">Biaya Depresiasi &nbsp;<span class="badge badge-pill  badge-warning">3.3</span> &nbsp;<a data-toggle="popover" title="Biaya Depresiasi" data-content="Biaya yang diperoleh dari biaya investasi dikurangi dengan nilai umur ekonomis dari setiap item investasi." class="badge badge-info text-white">Info</a></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">                        
                        <label for="biaya_lisensi" class="col-sm-6 col-form-label text-right">Biaya Perizinan dan Legalitas (Tahun Pertama) &nbsp;<span class="badge badge-pill  badge-warning">3.5</span> &nbsp;<a data-toggle="popover" title="Biaya License" data-content="Biaya License + ISO9001 (Tahun Pertama), Komponen untuk memasukkan biaya lisensi." class="badge badge-info text-white">Info</a></label>
                    ...
                    <div class="form-group row">                        
                        <label for="persen_lisensi" class="col-sm-6 col-form-label text-right">Biaya Perizinan dan Legalitas mulai tahun ke-2 (%) &nbsp;<span class="badge badge-pill  badge-warning">3.6</span> &nbsp;<a data-toggle="popover" title="Prosentase Biaya License" data-content="Biaya License + ISO9002 mulai tahun ke-2 (Prosentase), Prosentase biaya lisensi untuk tahun ke - 2 dan seterusnya." class="badge badge-info text-white">Info</a></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">                        
                        <label for="biaya_marketing" class="col-sm-6 col-form-label text-right">Biaya Marketing (%) &nbsp;<span class="badge badge-pill  badge-warning">3.7</span> &nbsp;<a data-toggle="popover" title="Biaya Marketing" data-content="Biaya Marketing (Prosentase)" class="badge badge-info text-white">Info</a></label>
                        <div class="col-sm-6">
