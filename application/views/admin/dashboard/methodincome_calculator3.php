            ...
            <div class="card text-center">
                ...
                <!-- <form method="POST" name="frmhalaman3" id="frmhalaman3" action="<?=base_url() ?>manage/add/incomebased_output"> -->
                    ...
                    <div class="form-group row">                        
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="<?= $biaya_depresiasi; ?>" class="form-control  form-control-sm col-sm-8" id="biaya_depresiasi" name="biaya_depresiasi" placeholder="#.##0,00" aria-describedby="biaya_depresiasiDesc" required>
