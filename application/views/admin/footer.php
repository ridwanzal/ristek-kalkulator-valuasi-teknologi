        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                ...
                <ul class="list-unstyled text-small listfooters">
                    ...
                    <li><a class="text-muted" href="#">Market based</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <h5>Informasi</h5>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-xs-12">
                <span class="text-muted"> <img height="20" src="https://frp.comnets.id//images/ristek-brin.png">&nbsp;&nbsp;Copyright SIKAV © 2020. All Right Reserved <a style="" href='https://www.ristekbrin.go.id/'>Kementerian Ristek / BRIN </a>Republik Indonesia
            </div>
...
<script src="<?php echo base_url();?>/assets/js/services/incomebased_modal_harga.js"></script>
