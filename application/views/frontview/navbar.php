                ...
                <ul class="navbar-nav mr-auto navmain">
                  ...
                  <form method="GET" action="<?php echo base_url(); ?>/blog/blog_content_list_search">
                    <div style:display:flex; class="searchings">
                      <a class="nav-link btn-xs btn-success btn-sm" style="border-radius:4px;" href="<?php base_url();?>auth/login" title="Kontak"><img src="<?php echo base_url()?>assets/frontview/img/login.svg" height="20" style="position:relative;top:-2px;">&nbsp;&nbsp;Inventor Login <span class="sr-only"></span></a>
                    </div>
                </form>
              </div>
            </nav>
